...
<main>
    ...
    <div class="main-content">
        <p><a href="<?php echo BASE_URL; ?>/detalleventas/registro">Registrar detalle</a></p>
                ...
                <table class="table table-bordered text-center align-middle">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th><i class="fa-solid fa-receipt"></i> Venta</th>
                    ...
                    <tbody>
                        <?php foreach ($detalleventas as $detalle): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo BASE_URL; ?>/detalleventas/registro/<?php echo $detalle['id_detalle']; ?>" style="color:#16a34a;"><i class="fa-solid fa-pen"></i></a>
                                    <form action="<?php echo BASE_URL; ?>/detalleventas/eliminar_detalle" method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar este detalle?');">
